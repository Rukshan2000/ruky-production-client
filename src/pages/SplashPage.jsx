  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-900">
      <div className="relative inline-flex">
        ...
        <div className="absolute top-0 left-0 w-10 h-10 bg-yellow-500 rounded-full animate-ping"></div>
        <div className="absolute top-0 left-0 w-10 h-10 bg-yellow-500 rounded-full animate-pulse"></div>
      </div>
    </div>
  );
}
