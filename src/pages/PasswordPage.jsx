    ...
    <div className="flex items-center justify-center h-screen bg-gray-800">
      <div className="p-8 bg-gray-800 border-4 border-yellow-600 rounded">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col items-center">
          ...
          />
          <button type="submit" className="px-4 py-2 text-white bg-gray-500 rounded hover:bg-yellow-600">Submit</button>
        </form>
        {/* Alert box for incorrect password */}
        {submitted && password !== correctPassword && (
          <div className="mt-4 text-yellow-600">Incorrect password. Please try again.</div>
        )}
      </div>
    </div>
  );
